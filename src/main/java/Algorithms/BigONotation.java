...
public class BigONotation {
    ...
    public static void main(String[] args) {
       ...
       /* BigONotation testAlgo = new BigONotation(10);
        testAlgo.addItemToArray(10);
        System.out.println(Arrays.toString(testAlgo.theArray));
        testAlgo.addItemToArray(12);
        System.out.println(Arrays.toString(testAlgo.theArray));
        testAlgo.addItemToArray(13);
        System.out.println(Arrays.toString(testAlgo.theArray));*/
...
*/
    ...
    public void addItemToArray(int newItem) {
        ...
        endTime = System.currentTimeMillis();
        System.out.println("addItemToArray Took " + (endTime - startTime));
        System.out.println("addItemToArray startTime " + startTime);
        System.out.println("addItemToArray endTime " + endTime);
    ...
    public void linearSearchForValue(int value) {
        ...
        System.out.println("Value Found: " + indexsWithValue);
        System.out.println("Value Found: " + indexsWithValue.split(" ").length);
