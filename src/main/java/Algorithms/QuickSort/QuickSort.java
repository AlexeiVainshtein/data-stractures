...
public class QuickSort {
    ...
    public int partitionArray(int left, int right, int pivot) {
        ...
        while (true) {
            ...
            while (leftPointer < theArray.length && theArray[++leftPointer] < pivot)
                System.out.println(leftPointer + " This");
            ...
            if (leftPointer >= rightPointer) {
                System.out.println("*************************");
                System.out.println(leftPointer + " and the right is: " + rightPointer);
                ...
                System.out.println("########################");
                System.out.println(leftPointer + " And right is: " + rightPointer + " pivot " + pivot);
                printHorzArray(leftPointer, rightPointer);
        ...
        System.out.println(leftPointer + " And " + right);
        printHorzArray(leftPointer, right);
